...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($user_name) && !empty($password) && !empty($email) && !empty($gender) && !empty($age) && !empty($telephone) && !empty($country) && !is_numeric($user_name)) {
        ...
        $query = "INSERT INTO site (user_id, user_name, password, email, gender, age, telephone, country) VALUES ('$user_id', '$user_name', '$hashed_password', '$email', '$gender', '$age', '$telephone', '$country')";
